...
class Image extends Media {
    ...
    get image() {
     ...
     generateHTMLCard() {
        ...
        const imageCard = `
        <figure id="${this._id}" class="medias_photographer" aria-label="media__image" tabindex="0">
                <a  tabindex="0">
                    <img class="medias-photographer_pic" src="../assets/medias/${this._photographerId}/${this._image}" alt="${this._title}" >
                </a>
